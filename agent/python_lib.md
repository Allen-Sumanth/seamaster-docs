Python Lib SDK is how user's will write code

Below is how user's code is actually executed and IPC happens between the python sandbox and the golang simulator/engine

PLEASE INFER HOW THE PYTHON LIBRARY WILL WORK AND EXPOSE BASED ON ./user_code.md and the below wrapper.py
...
from submission import spawn_policy as _spawn_policy # in sandbox submission dir 
# !!!!!!!!!!!! THE ABOVE LINE POINTS TO THE CODE THE PLAYER HAS WRITTEN !!!!!!!!!!
...
# PYTHON LIB
The python library provides HELPFUL FUNCTIONS AND ABSTRACTS for easy writing code and strategies with for example getSpawnableLocations, getNearestX which implements graph-traversal algorithms and stuffs.
It has also basic templates which can be easily used for beginners instead of writing their own code.

# TO BE PUT IN THE DOCS
- available templates
- actual api reference page for helpers etc.